...
?>
	...
	<div class="form-group"><!-- Image, photo ou avatar -->
		...
		<div class="col-md-10">
			...
			<div class="col-md-2" id="usrfipho_deleteButton"><a href="#" onclick='deleteFile_usrfipho()' class="btn"><i class="icon-trash"></i> <?= $this->lang->line('form.button.delete')?></a></div>
			<?php } ?>
			<input class="input-file col-md-9" id="usrfipho_file" name="usrfipho_file" class="form-control" type="file" >
