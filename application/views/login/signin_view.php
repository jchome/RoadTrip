...
<?php
$attributes_info = array('name' => 'SignInForm');
$fields_info = array("formSend" => "true");
echo form_open_multipart('login/signin/step2', $attributes_info, $fields_info );
?>

						<div class="form-group">
							<label for="exampleInputEmail1"><?= $this->lang->line('signin.form.email') ?></label>
						</div>
						...
						<input type="submit" class="btn btn-primary" value="<?= $this->lang->line('signin.form.step2') ?>" name="Submit"/>
