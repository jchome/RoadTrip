...
endforeach; ?>
		...
		$sharedUser = ($sharedVoyage->voyidusr == 0)?(new User_model()):($this->userservice->getUnique($this->db, $sharedVoyage->voyidusr));
		?>
				<li>
					...
					<a href="<?=base_url()?>index.php/voyage/detailvoyage/index/<?=$sharedVoyage->voyidvoy?>">
						<i class="glyphicon glyphicon-globe"></i> <?=$sharedVoyage->voylbnom?>
					</a><br/>
					<?= $this->lang->line('voyage.form.message.author', $sharedUser->usrlbnom) ?> <br/>
