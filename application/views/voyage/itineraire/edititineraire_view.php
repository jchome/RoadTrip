...
$fields_info = array('itiiditi' => $itineraire->itiiditi, 'itiidvoy' => $itineraire->itiidvoy);
...
?>
	...
	<div class="form-group"><!-- Nom de l'itinéraire -->
		...
		<div class="col-md-10">
		<input class="input-xlarge valtype form-control" type="text" name="idilbnom" id="idilbnom" value="<?= $itineraire->idilbnom ?>" required  >
